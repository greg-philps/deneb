A collection of Deneb templates using the Vega-Lite language

- the JSON templates are in the ***template*** directory
- PBIX examples of the templates in use are in the ***example*** directory
